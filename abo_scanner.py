...
def cek_sideways_yahoo(ticker_clean):
    ...
    # ANTI-BLOKIR: Jeda 0.4 detik agar tidak terkena cekal server Yahoo Finance
    time.sleep(0.4)
    ...
    try:
        ...
        # Saringan real trading diperketat ke 0.15 (sideways ketat kualitas A)
...
if __name__ == "__main__":
    # Kirim pesan teks pembuka pembuktian pancingan gerbang privasi Telegram Anda
