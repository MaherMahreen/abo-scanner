...
# =====================================================================
# DATA KREDENSIAL UTUH (SUDAH DIKUNCI DAN VALID)import os
import requests
import re
import time
...
def kirim_radar_telegram(pesan):
    url = f"https://api.telegram.org/bot8567909596:AAHy8NYFG6wL7PaZ6FbYo-kElMRcH6YuRx4/sendMessage"
    payload = {
...
def cek_sideways_yahoo(ticker_clean):
    ...
    # FIXED TOTAL: Alamat data grafik mentah Yahoo Finance dikunci resmi ke query1
    ...
    try:
        ...
        if response.status_code != 200:
            print(f"Skip {ticker_clean}: Gagal ambil data bursa (Status {response.status_code})")
            return
        ...
        # Saringan dilonggarkan ke 0.35 (35%) biar jaminan keluar notifikasinya melimpah pagi ini!
...
if __name__ == "__main__":
    ...
    # Pesan pembuka murni teks polos agar gerbang privasi Telegram langsung jebol terbuka
